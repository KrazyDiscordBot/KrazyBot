...
module.exports = {
    ...
    options: [{
        ...
        type: 6,
        required: false,
        description: "User whom you want to blur"
    }],
    ...
    run: async (bot, message, args) => {
        ...
        message.channel.send({ files: [new Discord.MessageAttachment(await Canvacord.blur(user.user.displayAvatarURL({ format: "png", dynamic: false })),"image.png")], embeds: [{ color: "GOLD", image: "attachment://image.png" }] })
    }
}